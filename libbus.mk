...
WorkspacePath          := "D:\Workroom\repository.svn\tinybus.svn\trunk"
ProjectPath            := "D:\Workroom\repository.svn\tinybus.svn\trunk"
...
Preprocessors          :=$(PreprocessorSwitch)_WINDOWS_ 
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
...
$(OutputFile): $(Objects)
	...
	@$(MakeDirCommand) "D:\Workroom\repository.svn\tinybus.svn\trunk/.build-debug"
	@echo rebuilt > "D:\Workroom\repository.svn\tinybus.svn\trunk/.build-debug/libbus"
...
$(IntermediateDirectory)/tinybus$(ObjectSuffix): tinybus.c $(IntermediateDirectory)/tinybus$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/Workroom/repository.svn/tinybus.svn/trunk/tinybus.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/tinybus$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/queue$(ObjectSuffix): queue.c $(IntermediateDirectory)/queue$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/Workroom/repository.svn/tinybus.svn/trunk/queue.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/queue$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/asyncqueue$(ObjectSuffix): asyncqueue.c $(IntermediateDirectory)/asyncqueue$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/Workroom/repository.svn/tinybus.svn/trunk/asyncqueue.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/asyncqueue$(ObjectSuffix) $(IncludePath)
